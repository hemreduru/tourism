...
@section('title', __('about_us.create'))

@section('content_header')
    <h1>{{ __('about_us.create') }}</h1>
@stop
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title_en') is-invalid @enderror"
                                id="title_en" name="title_en" value="{{ old('title_en') }}" placeholder="{{ __('about_us.title_en') }}">
                            @error('title_en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title_tr') is-invalid @enderror"
                                id="title_tr" name="title_tr" value="{{ old('title_tr') }}" placeholder="{{ __('about_us.title_tr') }}">
                            @error('title_tr')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title_nl') is-invalid @enderror"
                                id="title_nl" name="title_nl" value="{{ old('title_nl') }}" placeholder="{{ __('about_us.title_nl') }}">
                            @error('title_nl')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote @error('content_en') is-invalid @enderror" id="content_en" name="content_en" rows="5" placeholder="{{ __('about_us.content_en') }}">{{ old('content_en') }}</textarea>
                            @error('content_en')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote @error('content_tr') is-invalid @enderror" id="content_tr" name="content_tr" rows="5" placeholder="{{ __('about_us.content_tr') }}">{{ old('content_tr') }}</textarea>
                            @error('content_tr')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote @error('content_nl') is-invalid @enderror" id="content_nl" name="content_nl" rows="5" placeholder="{{ __('about_us.content_nl') }}">{{ old('content_nl') }}</textarea>
                            @error('content_nl')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
