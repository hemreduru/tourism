<nav class="navbar navbar-expand-lg navbar-dark fixed-top py-h3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container">
            <link rel="stylesheet" href="{{ asset('vendor/fontawesome-free/css/all.min.css') }}" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />

        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset('assets/img/logo/echt-zorg.logo.png') }}" width="250" alt="Echt Zorg Travel" />
        </a>
        <span class="d-lg-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" >
